...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['editPatient'])) {
        ...
        if (editPatient($conn, $id, $name, $address, $identity_card_number, $mobile_phone_number, $medical_record_number)) {
            $sweetAlert2PatientManage = 
                "Swal.fire({
                    icon: 'success',
                    title: 'Success!',
                    ...
                    window.location.href = 'patientManage.php';
                });";
        } else {
            $sweetAlert2PatientManage = 
                "Swal.fire({
...
<html lang="en">
  ...
  <head>
    ...
    <meta name="title" content="Patient Management" />
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
        ...
        <div class="row w-100 position-absolute" style="margin: 0; max-width: 100%;">
                    ...
                    <nav class="mt-2">
                        ...
                        <li class="nav-item sidebar-item active">
                            <a href="patientManage.php" class="nav-link sidebar-link">
                                <i class="nav-icon bi bi-people-fill text-primary color-i"></i>
                                <p class="color-p" style="font-weight: 500;">Patients</p>
                            </a>
                        </li>
                        <li class="nav-item sidebar-item">
            ...
            <div class="col-lg-10 div-two">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"><a href="#" class="nav-link">Patient Management</a></li>
                </ul>
                            ...
                            <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr class="text-center">
                                                ...
                                                <th class="px-3 py-2">Identity Card Number</th>
                                                <th class="px-3 py-2">Medical Record Number</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!-- Edit Button -->
                                                <button class="btn btn-edit btn-patient btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editPatientModal" 
                                                        data-id="<?= $patient['id'] ?>" 
                                                        data-name="<?= $patient['name'] ?>" 
                                                        data-address="<?= $patient['address'] ?>" 
                                                        data-mobile-phone-number="<?= $patient['mobile_phone_number'] ?>"
                                                        data-identity-card-number="<?= $patient['identity_card_number'] ?>"
                                                        data-medical-record-number="<?= $patient['medical_record_number'] ?>">Edit</button>

                                                    <!-- Delete Button -->
                                                    <form action="patientManage.php" method="POST" style="display:inline;">
                                                        <input type="hidden" name="id" value="<?= $patient['id'] ?>">
                                                        <button type="submit" name="deletePatient" class="btn btn-delete btn-patient btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                ...
                                <div class="modal fade" id="editPatientModal" tabindex="-1" aria-labelledby="editPatientLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="patientManage.php" method="POST">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control px-2 py-2" id="editMobilePhoneNumber" name="mobile_phone_number" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="editIdentityCardNumber" class="form-label">Identity Card Number</label>
                                                        <input type="text" class="form-control px-2 py-2" id="editIdentityCardNumber" name="identity_card_number" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="editMedicalRecordNumber" class="form-label">Medical Record Number</label>
                                                        <input type="text" class="form-control px-2 py-2" id="editMedicalRecordNumber" name="medical_record_number" required readonly>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-close-edit-modal btn-patient btn-secondary" data-bs-dismiss="modal">Close</button>
                                                    <button type="submit" name="editPatient" class="btn btn-update-edit-modal btn-patient btn-primary">Update</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script>
        ...
        const editPatientModal = document.querySelector('#editPatientModal');
        editPatientModal.addEventListener('show.bs.modal', function(event) {
            ...
            const identityCardNumber = button.getAttribute('data-identity-card-number');
            ...
            const modalIdentityCardNumber = document.querySelector('#editIdentityCardNumber');
            const modalMedicalRecordNumber = document.querySelector('#editMedicalRecordNumber');

            modalId.value = id;
            modalName.value = name;
            modalAddress.value = address;
            modalMobilePhoneNumber.value = mobilePhoneNumber;
            modalIdentityCardNumber.value = identityCardNumber;
            modalMedicalRecordNumber.value = medicalRecordNumber;
        });
