        ...
        <div class="row w-100 position-absolute" style="margin: 0; max-width: 100%;">
            ...
            <div class="col-lg-10 div-two">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"><a href="#" class="nav-link">Admin Dashboard</a></li>
                </ul>
                                ...
                                <div class="app-content-header">
                                  ...
                                  <div class="container-fluid">
                                    ...
                                    <div class="row">
                                      <div class="col-sm-6">
                                        <h3 class="mb-0">
                                          Welcome, <span style="text-transform: capitalize;"><?= htmlspecialchars($adminName); ?></span>!
                                        </h3>
                                      </div>
                                      <div class="col-sm-6">
                                      </div>
