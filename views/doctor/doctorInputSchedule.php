...
include '../../models_controllers/doctorInputScheduleController.php';
...
$sweetAlert2DoctorInputSchedule = '';

if ($_SERVER['REQUEST_METHOD'] === 'POST') { 
    if (isset($_POST['doctor_input_schedule'])) {
        $day = $_POST['day'];
        $start_time = $_POST['start_time'];
        $end_time = $_POST['end_time'];

        $result = inputCheckupSchedule($conn, $doctorId, $day, $start_time, $end_time);
        ...
        if ($result) {
            $sweetAlert2DoctorInputSchedule = 
                "Swal.fire({
                    ...
                    window.location.href = 'doctorInputSchedule.php';
                });";
        } else {
            $sweetAlert2DoctorInputSchedule = 
                "Swal.fire({
                    title: 'Error!',
                    text: 'Add schedule failed.',
                    icon: 'error'
                }).then(() => {
                    window.location.href = 'doctorInputSchedule.php';
                });";
...
<html lang="en">
  ...
  <head>
    ...
    <title>Doctor Check Schedule Input</title>
    <!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="Doctor Check Schedule Input" />
    <meta name="author" content="ColorlibHQ" />
    <meta
      name="description"
      content="Doctor Check Schedule Input."
    />
    <meta
      name="keywords"
      content="Doctor Check Schedule Input"
        ...
        <div class="row w-100 position-absolute" style="margin: 0; max-width: 100%;">
                    ...
                    <nav class="mt-2">
                        ...
                        <li class="nav-item sidebar-item active">
                            <a href="doctorInputSchedule.php" class="nav-link sidebar-link">
                                <i class="nav-icon bi bi-credit-card-2-back text-primary color-i"></i>
                                <p class="color-p" style="font-weight: 500;">Check Schedule Input</p>
                            </a>
                        </li>
                        <li class="nav-item sidebar-item">
            ...
            <div class="col-lg-10 div-two">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"><a href="#" class="nav-link">Input Schedule</a></li>
                </ul>
            ...
            <!--begin::App Main-->
                    <div class="container-fluid pe-5 w-100">
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <h2 class="mt-4">Input Schedule</h2>
                                <form method="POST" action="doctorInputSchedule.php">
                                    <label class="mt-3" for="day">Select Day :</label><br/>
                                    <select name="day" id="day" class="px-2 py-2 w-100" required>
                                    ...
                                    <div class="form">
                                        <label class="mt-3" for="start_time">Select Start Time :</label><br/>
                                        <input type="time" id="start_time" name="start_time" class="px-2 py-2 w-100" required>
                                    </div>
                                    <div class="form">
                                        <label class="mt-3" for="end_time">Select End Time :</label><br/>
                                        <input type="time" id="end_time" name="end_time" class="px-2 py-2 w-100" required>
                                    </div>
                                    <button type="submit" name="doctor_input_schedule" class="btn btn-add btn-doctor-input-schedule btn-primary mt-3">Input</button>
                                </form>          
