...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Title -->
        <title>Polyclinic - Check your health regularly so that your health is always maintained.</title>
    ...
    <body>
		...
		<ul class="pro-features">
			...
			<li>Enhanced Security - Advanced encryption and secure data management to protect sensitive information.</li>
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="#home-page"><img src="assets/img/logo1.png" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
                                            ...
                                            <li><a href="#options-page">Options</a></li>
		...
		<!-- Start Feautes -->
		<section class="Feautes section" id="options-page">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
		...
		<!-- Start Why choose -->
		<section class="why-choose section" id="about-us-page" >
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-12">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/jh5U5BnpGN8?si=OyBYp1NeU7UxXdLJ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</section>
		...
		<!-- Start portfolio -->
		<section class="portfolio section" id="portfolio-page" >
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
		...
		<!-- Start service -->
		<section class="services section" id="services-page">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
		...
		<!-- Pricing Table -->
		<section class="pricing-table section" id="pricing-page">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
		...
		<!-- Start Blog Area -->
		<section class="blog section" id="news-page">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
		...
		<!-- Start Appointment -->
		<section class="appointment" id="contact-us-page">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="single-footer f-link">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-12">
										<ul>
											<li><a href="#home-page"><i class="fa fa-caret-right" aria-hidden="true"></i>Home</a></li>
											<li><a href="#options-page"><i class="fa fa-caret-right" aria-hidden="true"></i>Options</a></li>
											<li><a href="#about-us-page"><i class="fa fa-caret-right" aria-hidden="true"></i>About Us</a></li>
											<li><a href="#portfolio-page"><i class="fa fa-caret-right" aria-hidden="true"></i>Portfolio</a></li>
											<li><a href="#services-page"><i class="fa fa-caret-right" aria-hidden="true"></i>Services</a></li>	
										</ul>
									</div>
									<div class="col-lg-6 col-md-6 col-12">
										<ul>
											<li><a href="#pricing-page"><i class="fa fa-caret-right" aria-hidden="true"></i>Pricing</a></li>
											<li><a href="#news-page"><i class="fa fa-caret-right" aria-hidden="true"></i>News</a></li>
											<li><a href="#contact-us-page"><i class="fa fa-caret-right" aria-hidden="true"></i>Contact Us</a></li>	
										</ul>
									</div>
								</div>
							</div>
